...
/**
 * Created by SZITTom on 2016/5/10.
 */
public class BaseFragmentManager {
    ...
    public BaseFragmentManager(FragmentManager manager) {
    ...
    public BaseFragmentManager remove(Fragment... fragments) {
    ...
    public BaseFragmentManager show(Fragment... fragments) {
        if (fragments != null && fragments.length > 0) {
            FragmentTransaction fragmentTransaction = beginTransaction();
            Fragment fragment = null;
            for (int i = 0; i < fragments.length; i++) {
    ...
    public BaseFragmentManager hide(Fragment... fragments) {
        if (fragments != null && fragments.length > 0) {
